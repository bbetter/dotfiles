...
for dir in hypr ags ghostty swaync swaylock cava neofetch mpv scripts theme fastfetch; do
...
# Stow всі конфіги
stow -v hypr ags ghostty swaync swaylock cava neofetch mpv scripts 2>/dev/null || true
